<%-- 
    ...
    Created on : 19-Jul-2023, 10:10:00 PM
    Author     : AN515-57
--%>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayoutsThree" aria-labelledby="headingThree" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="createRoleController">Add Role</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <form method="POST" action="createCategoryController">
                                <div class="card-body">
                                    <table id="datatablesSimple">
                                        <tbody>
                                            <tr>
                                                <th>Category Name</th>
                                                <td><input type="text" id="categoryName" name="categoryName"/><br></td>
                                            </tr>
