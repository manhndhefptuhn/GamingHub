                    ...
                    <div class="px-4 py-5">
                        ...
                        <c:forEach var="listOrderDetail" items="${listOrderDetail}">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <span class="text-muted"><fmt:formatNumber pattern="#,##0" value="${listOrderDetail.getTotalCost()}"/> VNÐ</span>
                            </div>
                        </c:forEach>
                        <div class="d-flex justify-content-between mt-3">
                            <span class="font-weight-bold">Total</span>
                            <span class="font-weight-bold theme-color"><fmt:formatNumber pattern="#,##0" value="${orderTotalCost}"/> VNÐ</span>
                        </div>  
