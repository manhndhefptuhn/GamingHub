...
<html lang="zxx">
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-lg-6 p-0">
                        <div class="categories__item categories__large__item set-bg"
                             data-setbg="<%= request.getContextPath()%>/img/shop/10001.png">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8">
                        <ul class="filter__controls">
                            ...
                            <li data-filter=".kid">Work PCs</li>
                            <li data-filter=".accessories">Laptops</li>
        ...
        <section class="banner set-bg" data-setbg="<%= request.getContextPath()%>/img/shop/10001/png">
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                        ...
                        <div class="trend__content">
                            ...
                            <div class="trend__item">
                                <div class="trend__item__pic">
                                    <img src="<%= request.getContextPath()%>/img/trend/ht-1.jpg" alt="">
                                </div>
                            ...
                            <div class="trend__item">
                                <div class="trend__item__pic">
                                    <img src="<%= request.getContextPath()%>/img/trend/ht-2.jpg" alt="">
                                </div>
                                <div class="trend__item__text">
                            ...
                            <div class="trend__item">
                                <div class="trend__item__pic">
                                    <img src="<%= request.getContextPath()%>/img/trend/ht-3.jpg" alt="">
                                </div>
                                <div class="trend__item__text">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="trend__content">
                            ...
                            <div class="trend__item">
                                <div class="trend__item__pic">
                                    <img src="<%= request.getContextPath()%>/img/trend/bs-1.jpg" alt="">
                                </div>
                                <div class="trend__item__text">
                                    <h6>Cotton T-Shirt</h6>
                                    <div class="rating">
                            ...
                            <div class="trend__item">
                                <div class="trend__item__pic">
                                    <img src="<%= request.getContextPath()%>/img/trend/bs-2.jpg" alt="">
                                </div>
                                <div class="trend__item__text">
                            ...
                            <div class="trend__item">
                                <div class="trend__item__pic">
                                    <img src="<%= request.getContextPath()%>/img/trend/bs-3.jpg" alt="">
                                </div>
                                <div class="trend__item__text">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="trend__content">
                            ...
                            <div class="trend__item">
                                <div class="trend__item__pic">
                                    <img src="<%= request.getContextPath()%>/img/trend/f-1.jpg" alt="">
                                </div>
                                <div class="trend__item__text">
                            ...
                            <div class="trend__item">
                                <div class="trend__item__pic">
                                    <img src="<%= request.getContextPath()%>/img/trend/f-2.jpg" alt="">
                                </div>
                                <div class="trend__item__text">
                            ...
                            <div class="trend__item">
                                <div class="trend__item__pic">
                                    <img src="<%= request.getContextPath()%>/img/trend/f-3.jpg" alt="">
                                </div>
                                <div class="trend__item__text">
