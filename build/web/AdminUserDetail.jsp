<%-- 
    ...
    Created on : Jun 9, 2023, 11:01:36 AM
    Author     : User
--%>
...
<!--                <button type="button" id="changepass" name="changepass" class="btn btn-primary">Change Password</button>-->
                ...
                <button type="button" id="changePass" name="changPass" class="btn btn-danger"><a href="changePassword.html" style="color: white">Change password</a></button>
              </div>
            </div>
          </div>
        </div>
